"""Pure domain calculations for opening balance entries.

No I/O — only business logic that is safe to test without a database.
"""
...
class OpeningBalanceCalculator:
    """Service for creating opening balance entries.
