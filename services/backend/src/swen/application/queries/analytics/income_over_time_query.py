...
class IncomeOverTimeQuery:
    ...
    @classmethod
    def from_factory(cls, factory: RepositoryFactory) -> IncomeOverTimeQuery:
    ...
    async def execute(
        ...
        return await self._analytics.income_over_time(
            months=months,
            end_month=end_month,
