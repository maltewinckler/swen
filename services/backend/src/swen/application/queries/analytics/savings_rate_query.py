...
class SavingsRateQuery:
    """Return monthly savings rate percentages."""
    ...
    @classmethod
    def from_factory(cls, factory: RepositoryFactory) -> SavingsRateQuery:
    ...
    async def execute(
        ...
        return await self._analytics.savings_rate_over_time(
            months=months,
            end_month=end_month,
