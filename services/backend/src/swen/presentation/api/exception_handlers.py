...
ERROR_CODE_TO_STATUS: dict[ErrorCode, int] = {
    ...
    # 422 Unprocessable Content - business rule violations
    ErrorCode.BUSINESS_RULE_VIOLATION: status.HTTP_422_UNPROCESSABLE_CONTENT,
    ErrorCode.TRANSACTION_ALREADY_POSTED: status.HTTP_422_UNPROCESSABLE_CONTENT,
    ErrorCode.TRANSACTION_ALREADY_DRAFT: status.HTTP_422_UNPROCESSABLE_CONTENT,
    ErrorCode.MIXED_CURRENCY: status.HTTP_422_UNPROCESSABLE_CONTENT,
    ErrorCode.UNSUPPORTED_CURRENCY: status.HTTP_422_UNPROCESSABLE_CONTENT,
    ErrorCode.INACTIVE_ACCOUNT: status.HTTP_422_UNPROCESSABLE_CONTENT,
    ErrorCode.EMPTY_TRANSACTION: status.HTTP_422_UNPROCESSABLE_CONTENT,
