...
class TestCategoryCode:
    ...
    def test_subcategory_creation(self):
        ...
        subcategory = CategoryCode(code="GROCERIES", name="Grocery Shopping", parent_code="FOOD")
    ...
    def test_code_normalization_uppercase(self):
        ...
        category = CategoryCode(code="food", name="Food & Dining", parent_code="expenses")
    ...
    def test_category_equality(self):
        ...
        category2 = CategoryCode(code="food", name="Food & Dining")  # Same but lowercase
    ...
    def test_subcategory_equality(self):
        ...
        subcategory1 = CategoryCode(code="GROCERIES", name="Grocery Shopping", parent_code="FOOD")
        subcategory2 = CategoryCode(code="groceries", name="Grocery Shopping", parent_code="food")
        subcategory3 = CategoryCode(code="GROCERIES", name="Grocery Shopping", parent_code="EXPENSES")
    ...
    def test_hierarchical_category_structure(self):
        ...
        transport = CategoryCode(code="TRANSPORT", name="Transportation", parent_code="EXPENSES")

        # Level 2 subcategories
        groceries = CategoryCode(code="GROCERIES", name="Grocery Shopping", parent_code="FOOD")
        restaurants = CategoryCode(code="RESTAURANTS", name="Restaurants", parent_code="FOOD")
    ...
    def test_special_characters_in_names(self):
        ...
        category = CategoryCode(code="MISC", name="Miscellaneous & Other Items (General)")
    ...
    def test_mixed_alphanumeric_codes(self):
        ...
        category = CategoryCode(code="FOOD01", name="Primary Food Category", parent_code="EXP001")
    ...
    def test_unicode_characters_in_names(self):
        ...
        category = CategoryCode(code="INTL", name="International & Foreign Currency Transactions")
