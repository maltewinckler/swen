...
class TestFindPaymentEntry:
    ...
    def test_matches_source_iban(self, mock_account, mock_entry, mock_metadata):
        ...
        savings = mock_account(AccountType.ASSET, "Savings", iban="DE12345678901234567890")
...
class TestTransactionListItemDTO:
    ...
    def test_split_transaction_shows_split(self, mock_account, mock_entry, mock_metadata):
