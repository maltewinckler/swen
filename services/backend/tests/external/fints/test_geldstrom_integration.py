...
These tests connect to real banks via FinTS and require:
- Real bank credentials (FINTS_BLZ, FINTS_USERNAME, FINTS_PIN, FINTS_ENDPOINT)
- Network access
- Some tests require manual TAN approval
