...
4. Persist to real database (Testcontainers PostgreSQL)
...
# ============================================================================
# Fixtures (using Testcontainers PostgreSQL via db_session)
# ============================================================================


@pytest_asyncio.fixture
async def setup_chart_of_accounts(db_session):
    """Set up minimal chart of accounts needed for opening balance."""
    account_repo = AccountRepositorySQLAlchemy(db_session, TEST_USER_CONTEXT)
...
@pytest_asyncio.fixture
async def setup_asset_account_and_mapping(db_session, setup_chart_of_accounts):
...
class TestOpeningBalanceE2E:
    ...
    async def test_first_sync_creates_opening_balance_in_database(
        ...
        counter_account_resolution_service.get_fallback_account.side_effect = (
            mock_get_fallback
        )
