...
class TestAccountPersistenceIntegration:
    ...
    @pytest.mark.asyncio
    async def test_save_and_retrieve_fints_account(self, db_session):
    ...
    @pytest.mark.asyncio
    async def test_multiple_accounts_for_user(self, db_session):
...
class TestTransactionPersistenceIntegration:
    ...
    @pytest.mark.asyncio
    async def test_save_transactions_from_fints(self, db_session):
    ...
    @pytest.mark.asyncio
    async def test_incremental_transaction_sync(self, db_session):
    ...
    @pytest.mark.asyncio
    async def test_duplicate_transaction_prevention(self, db_session):
    ...
    @pytest.mark.asyncio
    async def test_transactions_without_bank_reference(self, db_session):
...
class TestComplexPersistenceScenarios:
    ...
    @pytest.mark.asyncio
    async def test_complete_sync_workflow(self, db_session):
    ...
    @pytest.mark.asyncio
    async def test_date_range_queries(self, db_session):
