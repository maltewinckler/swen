...
✅ Small UX improvements with clear motivation
✅ New FinTS bank compatibility fixes
✅ Performance improvements with benchmarks

❌ Large new features without prior discussion
❌ Dependencies that add significant supply chain risk
❌ Changes to the core DDD/hexagonal architecture without strong justification
❌ Frontend rewrites (the current frontend works; a review + incremental improvements are preferred)

## Getting Help

For questions about the codebase, open a [GitHub Discussion](https://github.com/maltewinckler/swen/discussions) or a draft PR with your question.
